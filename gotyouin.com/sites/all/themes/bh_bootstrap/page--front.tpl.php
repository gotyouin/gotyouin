        ...
        <div class="docs-inner-wrapper">
          <div class="iphone">
            <div class="iphone-content">
              <div id="iwindow">
                <img src="<?php echo DBS_STATIC;?>/sites/all/themes/bh_bootstrap/images/splash.jpg" alt="" />
              </div>
            </div>
          </div>
          ...
          <div class="span8">
            <div class="inner">
              ...
              <p class="feature-description">Barbers, sign up and use Got You In, risk-free, for the next 30 
days! Got You In is always free to customers of barbers</p>
          ...
          <div class="span8">
            ...
            <p class="feature-description">Got You In is a scheduling solution for barbers and their customers.  
Got You In also introduced the first universal scheduling app for barbers.  Through the Got You In solution, 
barbers and their clients can schedule, and manage, haircut appointments in real-time, anytime and anywhere. Got 
You In eliminates the process of manually texting or calling to schedule a haircut appointment, on the part of barbers and their customers.</p>
            <div class="feature-example feature-example-fullbleed displaypiece">
              <img src="<?php echo DBS_STATIC;?>/sites/all/themes/bh_bootstrap/images/home.jpg" alt="" />
            </div>
          </div>
          </article>
          ...
          <div class="span8">
            ...
            <div class="feature-example feature-example-fullbleed displaypiece">
              <img src="<?php echo DBS_STATIC;?>/sites/all/themes/bh_bootstrap/images/shop.jpg" alt="" />
            </div>
          </div>
          </article>
          ...
          <div class="span8">
            ...
            <div class="feature-example feature-example-fullbleed displaypiece">
              <img src="<?php echo DBS_STATIC;?>/sites/all/themes/bh_bootstrap/images/search.jpg" alt="" />
            </div>
          </div>
          </article>
