...
/*
 * Custom registration logic for Independent Barbers
 */
?>
...
<div class="container">
     ...
     ?>
               ...
               <div id='step-1'>
                    <h3>Step #1 - create your Independent Barber's account</h3>
               </div>
...
<script type="text/JavaScript">
     jQuery(function() {
          ...
          //jQuery ('#edit-profile-independent-barber-field-bio').insertBefore('#edit-actions');
          jQuery ('#edit-profile-independent-barber-field-services').hide();
          jQuery ('#edit-profile-independent-barber-field-services').insertBefore('#edit-actions');
          jQuery ('#edit-profile-independent-barber-field-barber-availability').insertBefore('#edit-actions');
          jQuery ('#edit-picture').insertBefore('#edit-actions');

		jQuery( '#profile-independent-barber-field-twitter-handlei-add-more-wrapper' ).appendTo( '#edit-field-phone' );
		jQuery( '#profile-independent-barber-field-facebooki-add-more-wrapper' ).appendTo( '#edit-field-phone' );
		jQuery( '#profile-independent-barber-field-linkedini-add-more-wrapper' ).appendTo( '#edit-field-phone' );
		jQuery( '#profile-independent-barber-field-google-plusi-add-more-wrapper' ).appendTo( '#edit-field-phone' );
		jQuery( '#profile-independent-barber-field-instagrami-add-more-wrapper' ).appendTo( '#edit-field-phone' );
          
		// set up validation 2013-02-22
		jQuery( '#edit-profile-independent-barber-field-facebooki-und-0-value, #edit-profile-barber-field-facebook-und-0-value' ).addClass( 'validateUrlOptional' );
		...
		jQuery( "#user-register-form" ).miniValidate();
    });
</script>
